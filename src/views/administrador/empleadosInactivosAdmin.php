<?php
    ...
    <head>
        ...
        <title>Empleados inicativos</title>
    </head>
    <body>
    <div class="navbar">
        ...
        <div class="Encabezado">
            <h1 style="margin-top: 40px; margin-left: 26.5px; margin-bottom: 20px;" >Empleados baja</h1>
        </div>
        <div class="buscar">
        ...
        <?php
            ...
            if (isset($_GET['buscar'])) {
                ...
                $sql = "SELECT a.No_celular, be.reingreso, v.id_vacante, p.Puesto, 
                empl.*, dep.Departamento FROM vacantes as v, puestos as p, aspirantes as a, 
                departamentos as dep, empleados as empl, empresas as em, baja_empleados as be 
                WHERE a.id_Aspirante = empl.id_Aspirante AND empl.id_Departamento = dep.id_Departamento 
                AND v.id_vacante = a.id_Vacante AND p.id_Puesto = v.id_Puestos AND dep.id_empresa = em.id_Empresa AND empl.Status = 0 AND '$empresa' = em.id_Empresa AND be.id_empleado = empl.id_Empleado
                AND ($condiciones_str)";
            } else {
                $sql = "SELECT a.No_celular,  be.reingreso, v.id_vacante, p.Puesto, 
                empl.*, dep.Departamento FROM vacantes as v, puestos as p, aspirantes as a, 
    ...
    <table>
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php if($consulta["reingreso"] == 0){
                            echo "No Permitido";
                        }else{
                            echo "Permitido";
                        }  
                ...
                <td>
                    <li class="dropdown1">
                            ...
                            <path fill-rule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
                                ...
                                <div class="dropdown_opcionesInactivo">
