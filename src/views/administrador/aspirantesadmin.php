...
<div class="navbar">
    ...
    <div class="Encabezado">
        <h1 style="margin-top: 40px; margin-left: 26.5px; margin-bottom: 20px;" >Aspirantes</h1>
    </div>
    <a href="registrarNuevoAspirante.php" id="BTNuevoAspirante">Nuevo Aspirante</a>
    <div class="buscar">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td> <?php echo $filas["No_celular"]; ?></td>
                    <td>
                        <?php
                        if ($filas["Status"] == 1) {
                            echo "Activo";
                    ...
                    <li class="dropdown1">
                            ...
                            <path fill-rule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
                                ...
                                <div class="dropdown_opcionesAspirantes">
                                    <form action="altaEmpleado.php" method="post"> <button type="submit"  id="btn" value="<?= $filas["id_Aspirante"] ?>" name="ID">Aceptar</button> </form>

                                    <form action="entrevistaAspirante.php" method="post"> <button type="submit"  id="btn" value="<?= $filas["id_Aspirante"] ?>" name="ID">Entrevista</button> </form>
