...
<div class="navbar">
    ...
    <?php
        ...
        if (isset($_GET['buscar'])) {
            ...
            AND v.id_vacante = a.id_Vacante AND p.id_Puesto = v.id_Puestos AND dep.id_empresa = em.id_Empresa AND empl.Status = 1 AND '$empresa' = em.id_Empresa
            AND ($condiciones_str)";
        } else {
            $sql = "SELECT a.No_celular, v.id_vacante, p.Puesto, 
            empl.*, dep.Departamento FROM vacantes as v, puestos as p, aspirantes as a, 
...
<table>
    ...
    ?>
        ...
        <tr>
            ...
            <!-- <td><?php 
            // echo $consulta["Numero_nomina"]; 
            ?></td>
            <td>
            <?php 
            // echo $consulta["No_celular"]; 
            ?></td>
            <td><?php 
            ...
            <li class="dropdown1">
                ...
                <path fill-rule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
                    ...
                    <div class="dropdown_opcionesEmpleadosMedico">
                    <form action="ExamenMedico.php" method="post"> <button type="submit"  id="btn" value="<?= $consulta["id_Empleado"] ?>" name="ID">Examen Medico</button></form>
                    </div>
            </li>
            </td>
        </tr>
