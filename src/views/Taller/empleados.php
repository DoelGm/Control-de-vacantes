...
<body>
    ...
    <?php
        ...
        if (isset($_GET['buscar'])) {
            ...
            $sql = "SELECT a.No_celular, v.id_vacante, v.Herramientas, p.Puesto, 
            ...
            departamentos as dep, empleados as empl, empresas as em
            WHERE a.id_Aspirante = empl.id_Aspirante AND empl.id_Departamento = dep.id_Departamento 
            AND v.id_vacante = empl.id_Vacante AND p.id_Puesto = empl.id_Puesto AND dep.id_empresa = em.id_Empresa AND empl.Status = 1 AND '$empresa' = em.id_Empresa AND dep.id_Departamento = '$departamento'";
        }
        ...
        <tr>
            ...
            <li class="dropdown1">
                ...
                <path fill-rule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
                    ...
                    <div class="dropdown_opcionesEmpleadosTaller">
