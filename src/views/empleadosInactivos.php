...
<div class="navbar">
    ...
    <?php
        ...
        if (isset($_GET['buscar'])) {
            ...
            AND v.id_vacante = a.id_Vacante AND p.id_Puesto = empl.id_Puesto  AND dep.id_empresa = em.id_Empresa AND empl.Status = 0 AND '$empresa' = em.id_Empresa AND be.id_empleado = empl.id_Empleado
            AND ($condiciones_str)";
        } else {
            $sql = "SELECT a.No_celular,  be.reingreso, v.id_vacante, p.Puesto, 
            empl.*, dep.Departamento FROM vacantes as v, puestos as p, aspirantes as a, 
    ...
    ?>
        ...
        <tr>
            ...
            <li class="dropdown1">
                ...
                <div class="dropdown_opcionesEmpleadosInactivo">
                    ...
                    <!-- <form action="" method="post">
                        <button type="submit" id="btn" value="" name="ID">Subir Archivos</button>
                    </form> -->
                </div>
            </li>
